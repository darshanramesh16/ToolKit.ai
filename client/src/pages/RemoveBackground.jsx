...
const RemoveBackground = () => {
  ...
  return (
    <div className='flex h-full overflow-y-scroll p-6 items-start flex-wrap gap-4
    text-slate-700'>
      {/* left col */}
      ...
      {/* right col */}
      {/* right col */}
<div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 h-[520px]">
  <div className="flex items-center gap-3">
  ...
  {!content ? (
    ...
    <div className="mt-3 flex-1 flex justify-center items-center overflow-auto">
      <img
        src={content}
        alt="Processed"
