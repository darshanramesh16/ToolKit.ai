  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            font-semibold mx-auto leading-[1.2]'>Create amazing content <br /> with <span className='text-[#b31b1b]'>AI tools</span></h1>
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            hover:scale-102 active:scale-95 transition cursor-pointer'>Start Creating</button>
